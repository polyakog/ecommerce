import { SlectedProductType } from "@/app/admin/ProductTable"
import { Product } from "@prisma/client"
import React from "react"

type PropsType = {
    products: Product[]
    selectedProduct: SlectedProductType[]
    setIsApproveModal: (isApproveModal: boolean) => void  
    
}

const DeleteApproveModal = ({ products, selectedProduct, setIsApproveModal}: PropsType) => {
