...
const ProductTable = ({ products }: ProudctTablePropsType) => {
    ...
    const classTable = `${selectedProduct?.length? " bg-slate-400 rounded-t-lg": ""} pb-2 border-b-2 border-gray-800 `
    return (
           ...
           <div className="flex justify-end mt-2 mr-2">
            ...
            : 
             <div className="flex gap-3 items-center mt-2">
                ...
                <button className="btn btn-warning btn-xs sm:btn-sm md:btn-md lg:btn-md ">Удалить</button>
            </div>
           }   
